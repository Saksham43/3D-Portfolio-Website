      ...
      >
        <div className='relative w-full h-[230px]'>
          ...
          <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
            ...
            >
              <img src={instagram} alt="instagram" className='w-3/2 h-3/2 object-contain' />
            </div>
          </div>
        </div>
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>When I am not coding</p>
        <h2 className={styles.sectionHeadText}>I love to write songs.</h2>
      </motion.div>
